...
public class BreadthFirstSearch extends ASearchingAlgorithm {
     ...
     */
    protected ArrayList<AState[]> solve() {
        ...
        while (!Q.isEmpty()) {
            ...
            for (AState state : getPossibleStates(current_state)) {
    ...
    protected AState[] getPossibleStates(AState current_state) {
        return domain.getAllPossibleStates(current_state);
    }

    /**
     * Makes sure Solution v contains a valid path, by following the goal back to the start by the kept "parent" of each state.
     *
    ...
    /**
     * Removes unnecessary state traversals kept in the original BFS result.
     *
     * @param path given path
     * @return path after modification.
     */
